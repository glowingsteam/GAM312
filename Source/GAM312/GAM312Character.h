...
#include "GAM312\SecurityCamera.h"
...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = SecurityCamera)
		bool viewingCamera = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SecurityCamera)
		int currentCameraIndex = 0;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = SecurityCamera)
		TArray<ASecurityCamera*> allCameras;
